...
UA = "SEMIL-Currency-Intelligence/2.0"
...
CORE_MARKET_TERMS = [
    "dollar","usd","brl","brazil real","federal reserve","fed",
    "treasury","yield","yields","inflation","interest rate","interest rates",
    "selic","copom","brazil fiscal","brazil deficit","brazil debt",
    "emerging market","emerging markets"
]

RELEVANCE_TERMS = [
    "dollar","usd","brl","real","brazil","fed","federal reserve","inflation",
    "interest","rate","rates","treasury","yield","yields","emerging",
    "fiscal","deficit","debt","commodity","commodities","oil","tariff",
    "geopolit","risk","jobs","employment","unemployment","selic","copom"
]
...
UP_PATTERNS = [
    ...
    "yields climb","treasury yields rise","risk aversion","risk-off",
    "fiscal concern","fiscal worries","fiscal risk","deficit widens",
    "debt rises","political uncertainty","geopolitical tension",
    "trade tensions","selic cut","rate cut in brazil"
]

DOWN_PATTERNS = [
    "dollar falls","dollar drops","dollar weakens","weaker dollar",
    "rate cut","rates lower","dovish","inflation cools","inflation eases",
    "disinflation","weak jobs","jobs weaken","yields fall","yields drop",
    "treasury yields fall","risk-on","risk appetite","capital inflow",
    "inflows to brazil","selic hike","rate hike in brazil","commodity rally"
]
...
def collect_public_news():
    ...
    return by_source, failures, sorted(checked)
...
def build_intelligence(latest):
    ...
    public_news, news_failures, checked_media = collect_public_news()
    ...
    score += clamp(media_score_total, -2, 2)
    ...
    result = {
        ...
        "method": "Motor determinístico SEMIL V3 — filtro material de notícias + custo zero",
        "score10": score,
        "outlook10": {
            "bias": bias,
